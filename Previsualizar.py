...
def previsualizar(e):
    ...
    def actualizar(e):
        ...
        tiempo = 566 / len(vb.barra_tiempo)
        slider_player.SetValue(player.Tell() / 1000)
        movimiento = wx.Point(vb.l_gr+ 52 + (player.Tell() / 1000 * tiempo), vb.t_gr+30)
    ...
    boton_pause = wx.BitmapButton(panel_reproductor, bitmap=wx.Bitmap("player_pause.png"), pos=(vb.l_rep+45, vb.t_rep+450))
