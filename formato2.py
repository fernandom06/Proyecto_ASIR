...
def previsualizar(video):
    ...
    #Video
    boton=wx.Button(panel_video)
    boton.Bind(wx.EVT_BUTTON,cargado)
    reproductor.player = wx.media.MediaCtrl(panel_video,fileName="Cabecera.mp4", pos=(250, 0), size=(500, 250))
