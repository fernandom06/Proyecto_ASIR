...
def grafica():
    ...
    gra1.plot(tiempo, y, color=vb.color_linea1)
    gra1.set_facecolor(vb.background1)
    ...
    gra1.spines['bottom'].set_color(vb.contorno1)
    gra1.spines['top'].set_color(vb.contorno1)
    gra1.spines['right'].set_color(vb.contorno1)
    gra1.spines['left'].set_color(vb.contorno1)
    gra1.tick_params(axis='both', colors=vb.label1)
    plt.xticks(rotation=70)

    gra2 = fig.add_subplot(2, 1, 2)
    gra2.plot(tiempo, z, color=vb.color_linea2)
    gra2.set_facecolor(vb.background2)
    gra2.set_xlim(0, tiempo[len(tiempo) - 1])
    gra2.set_xticks(x)
    gra2.set_title(vb.titulo2)
    gra2.spines['bottom'].set_color(vb.contorno2)
    gra2.spines['top'].set_color(vb.contorno2)
    gra2.spines['right'].set_color(vb.contorno2)
    gra2.spines['left'].set_color(vb.contorno2)
    gra2.tick_params(axis='both', colors=vb.label2)
